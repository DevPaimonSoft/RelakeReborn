...
public class CoreShaders {
    ...
    public static final ShaderProgram RENDERTYPE_ENTITY_CUTOUT_NO_CULL_Z_OFFSET = register("rendertype_entity_cutout_no_cull_z_offset", DefaultVertexFormat.NEW_ENTITY);
    ...
    public static final ShaderProgram RENDERTYPE_TEXT_BACKGROUND_SEE_THROUGH = register("rendertype_text_background_see_through", DefaultVertexFormat.POSITION_COLOR_LIGHTMAP);
    public static final ShaderProgram RENDERTYPE_TEXT_INTENSITY_SEE_THROUGH = register("rendertype_text_intensity_see_through", DefaultVertexFormat.POSITION_COLOR_TEX_LIGHTMAP);
