...
public class ArmorStandModel extends ArmorStandArmorModel {
    ...
    public void setupAnim(ArmorStandRenderState p_363470_) {
        ...
        this.rightBodyStick.xRot = (float) (Math.PI / 180.0) * p_363470_.bodyPose.getX();
        this.rightBodyStick.yRot = (float) (Math.PI / 180.0) * p_363470_.bodyPose.getY();
        this.rightBodyStick.zRot = (float) (Math.PI / 180.0) * p_363470_.bodyPose.getZ();
        this.leftBodyStick.xRot = (float) (Math.PI / 180.0) * p_363470_.bodyPose.getX();
        this.leftBodyStick.yRot = (float) (Math.PI / 180.0) * p_363470_.bodyPose.getY();
        this.leftBodyStick.zRot = (float) (Math.PI / 180.0) * p_363470_.bodyPose.getZ();
        this.shoulderStick.xRot = (float) (Math.PI / 180.0) * p_363470_.bodyPose.getX();
        this.shoulderStick.yRot = (float) (Math.PI / 180.0) * p_363470_.bodyPose.getY();
        this.shoulderStick.zRot = (float) (Math.PI / 180.0) * p_363470_.bodyPose.getZ();
    }
