...
public class WindChargeModel extends EntityModel<EntityRenderState> {
    ...
    @Override
    public void setupAnim(EntityRenderState p_365499_) {
        super.setupAnim(p_365499_);
        this.windCharge.yRot = -p_365499_.ageInTicks * 16.0F * (float) (Math.PI / 180.0);
        this.wind.yRot = p_365499_.ageInTicks * 16.0F * (float) (Math.PI / 180.0);
    }
}