...
public class FrogModel extends EntityModel<FrogRenderState> {
    ...
    public void setupAnim(FrogRenderState p_365078_) {
        ...
        this.animate(p_365078_.jumpAnimationState, FrogAnimation.FROG_JUMP, p_365078_.ageInTicks);
        this.animate(p_365078_.croakAnimationState, FrogAnimation.FROG_CROAK, p_365078_.ageInTicks);
        this.animate(p_365078_.tongueAnimationState, FrogAnimation.FROG_TONGUE, p_365078_.ageInTicks);
        if (p_365078_.isSwimming) {
            this.animateWalk(FrogAnimation.FROG_SWIM, p_365078_.walkAnimationPos, p_365078_.walkAnimationSpeed, 1.0F, 2.5F);
        } else {
            this.animateWalk(FrogAnimation.FROG_WALK, p_365078_.walkAnimationPos, p_365078_.walkAnimationSpeed, 1.5F, 2.5F);
        }

        this.animate(p_365078_.swimIdleAnimationState, FrogAnimation.FROG_IDLE_WATER, p_365078_.ageInTicks);
