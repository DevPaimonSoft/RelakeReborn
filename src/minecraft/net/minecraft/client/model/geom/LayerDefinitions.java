...
public class LayerDefinitions {
    ...
    public static Map<ModelLayerLocation, LayerDefinition> createRoots() {
        ...
        LayerDefinition layerdefinition14 = LayerDefinition.create(FelineModel.createBodyMesh(CubeDeformation.NONE), 64, 32);
        LayerDefinition layerdefinition15 = layerdefinition14.apply(FelineModel.BABY_TRANSFORMER);
        LayerDefinition layerdefinition16 = LayerDefinition.create(FelineModel.createBodyMesh(new CubeDeformation(0.01F)), 64, 32);
        ...
        builder.put(ModelLayers.CAT, layerdefinition14.apply(CatModel.CAT_TRANSFORMER));
        builder.put(ModelLayers.CAT_BABY, layerdefinition15.apply(CatModel.CAT_TRANSFORMER));
        builder.put(ModelLayers.CAT_COLLAR, layerdefinition16.apply(CatModel.CAT_TRANSFORMER));
        builder.put(ModelLayers.CAT_BABY_COLLAR, layerdefinition16.apply(FelineModel.BABY_TRANSFORMER).apply(CatModel.CAT_TRANSFORMER));
        ...
        builder.put(ModelLayers.OCELOT_BABY, layerdefinition15);
        ...
        builder.put(ModelLayers.STRIDER_BABY, layerdefinition22.apply(StriderModel.BABY_TRANSFORMER));
        builder.put(ModelLayers.STRIDER_BABY_SADDLE, layerdefinition22.apply(StriderModel.BABY_TRANSFORMER));
        ...
        builder.put(ModelLayers.VILLAGER_BABY, layerdefinition26.apply(VillagerModel.BABY_TRANSFORMER));
        ...
        builder.put(ModelLayers.WITHER_SKELETON, layerdefinition25.apply(meshtransformer4));
        ...
        WoodType.values().forEach(p_374591_ -> {
            builder.put(ModelLayers.createStandingSignModelName(p_374591_), layerdefinition53);
            builder.put(ModelLayers.createWallSignModelName(p_374591_), layerdefinition54);

            for (HangingSignRenderer.AttachmentType hangingsignrenderer$attachmenttype : HangingSignRenderer.AttachmentType.values()) {
                LayerDefinition layerdefinition55 = HangingSignRenderer.createHangingSignLayer(hangingsignrenderer$attachmenttype);
