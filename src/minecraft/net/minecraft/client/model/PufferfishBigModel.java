...
public class PufferfishBigModel extends EntityModel<EntityRenderState> {
    ...
    @Override
    public void setupAnim(EntityRenderState p_364587_) {
        super.setupAnim(p_364587_);
        this.rightBlueFin.zRot = -0.2F + 0.4F * Mth.sin(p_364587_.ageInTicks * 0.2F);
        this.leftBlueFin.zRot = 0.2F - 0.4F * Mth.sin(p_364587_.ageInTicks * 0.2F);
    }
}