...
public class SocialInteractionsScreen extends Screen {
    ...
    public void renderBackground(GuiGraphics p_283202_, int p_299912_, int p_301406_, float p_300377_) {
        ...
        p_283202_.blitSprite(RenderType::guiTextured, BACKGROUND_SPRITE, i, 64, 236, this.windowHeight() + 16);
        p_283202_.blitSprite(RenderType::guiTextured, SEARCH_SPRITE, i + 10, 76, 12, 12);
    }
