...
public class FileDownload {
                    ...
                    try {
                        ...
                        if (httpresponse.getStatusLine().getStatusCode() == 200) {
                            ...
                            FileDownload.ProgressListener filedownload$progresslistener = new FileDownload.ProgressListener(
                                pWorldName.trim(), this.tempFile, pSource, pStatus
                            );
                            ...
                            if (!pDownload.resourcePackUrl.isEmpty() && !pDownload.resourcePackHash.isEmpty()) {
                                try {
                                    ...
                                    FileDownload.ResourcePackProgressListener filedownload$resourcepackprogresslistener = new FileDownload.ResourcePackProgressListener(
                                        this.tempFile, pStatus, pDownload
                                    );
    ...
    void untarGzipArchive(String pWorldName, @Nullable File pTempFile, LevelStorageSource pLevelStorageSource) throws IOException {
        ...
        ProgressListener(
            final String pWorldName, final File pTempFile, final LevelStorageSource pLevelStorageSource, final RealmsDownloadLatestWorldScreen.DownloadStatus pDownloadStatus
        ) {
        ...
        ResourcePackProgressListener(final File pTempFile, final RealmsDownloadLatestWorldScreen.DownloadStatus pDownloadStatus, final WorldDownload pWorldDownload) {
            this.tempFile = pTempFile;
            this.downloadStatus = pDownloadStatus;
